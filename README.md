...
1. 安装 VS2022/VS2026社区版 的 C++桌面开发 后就能直接双击打开解决方案 Iocp20Coroutine\Iocp20Coroutine.sln;
...
6. 修改电脑本地hosts文件（C:\Windows\System32\drivers\etc\hosts）把域名 test.rtsgame.online 定位到 127.0.0.1
