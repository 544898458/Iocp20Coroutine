...
bool 還奀郯結Component::AddComponent(Entity& refEntity)
{
	...
	refEntity.m_sp還奀郯結 = std::make_shared<還奀郯結Component>(refEntity);
	return true;
}
