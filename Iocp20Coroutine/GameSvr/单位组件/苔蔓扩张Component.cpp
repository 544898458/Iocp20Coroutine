...
Ì¦ÂûÀ©ÕÅComponent::Ì¦ÂûÀ©ÕÅComponent(Entity& ref) :m_refEntity(ref), m_funCancel("Ì¦ÂûÀ©ÕÅComponent")
{
...
void Ì¦ÂûÀ©ÕÅComponent::OnEntityDestroy(const bool bDestroy)
{
