...
namespace 单位
{
	...
	{
		{基地, {{"基地","house_type06"},{1, 0,200}, 2.0f}},
		{兵厂, {{"兵厂","house_type19"},{2,11,100},2.0f} },
		{民房, {{"民房","house_type21"},{2, 3,50}, 1.0f} },
		{地堡, {{"地堡","house_type17"},{3, 5,500}, 2.0f} },
	};

	std::unordered_map<活动单位类型, 活动单位配置> g_map活动单位配置 =
	{
		{工程车,{{"工程车"	, "altman-yellow"	},{ 3,0,20}, 8 , 2} },
		{兵,	{{"兵"		, "altman-blue"		},{ 5,6,10}, 20, 8} },
		{近战兵,{{"近战兵"	, "axe-yellow"		},{ 8,8,18}, 15, 3} },
	};
