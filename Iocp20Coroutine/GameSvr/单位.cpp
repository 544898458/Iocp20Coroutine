...
namespace 单位
{
	...
	{
		//										晶体燃气HP	  警距 攻距	伤害 移速 前摇
		{工程车,{{"工程车"	, "altman-yellow"	},{ 3,0,20	}, {8 , 4,  1,	0.4f, 500ms}} },
		{兵,	{{"兵"		, "活动单位/步兵"	},{ 5,2,15	}, {20, 9,  3,	0.5f, 900ms}} },
		{近战兵,{{"近战兵"	, "axe-yellow"		},{ 8,3,18	}, {15, 4,  5,	0.5f, 600ms}} },
		{三色坦克,{{"三色坦克","活动单位/三色坦克"},{ 20,10,60},{30,20,15,	0.1f, 2s}} },
	};
	std::unordered_map<活动单位类型, 怪配置> g_map怪配置 = {
		//									 警距 攻距 伤  移速 前摇	血量
		{兵,	{{"怪"		, "altman-red"	},{20,8,	5, 0.2f,300ms}, 50} },
		{近战兵,{{"斧头怪"	, "axe-red"		},{15,3,	8, 0.2f,300ms}, 65} },
	};
