...
namespace 单位
{
	...
	std::unordered_map<单位类型, 建筑单位配置> g_map建筑单位配置 =
	{
		...
		{兵厂,	{{"兵营",	"建筑/兵厂",	"tacWht00"},	{25, 9,100}, 4.0f}},
		{民房,	{{"民房",	"建筑/民房",	"tclWht00"},	{20, 3,50},  3.f}},
		{地堡,	{{"地堡",	"建筑/地堡",	"音效/BUTTON"},	{30,11,400}, 3.0f}},
		{炮台,{{"炮台",	"建筑/炮台",	"音效/BUTTON"},	{35,12,100}, 2.5f}},
		{虫巢,{{"虫巢",	"建筑/虫巢",	"音效/BUTTON"},	{35,12,200}, 5.0f}},
	...
	std::unordered_map<单位类型, 活动单位配置> g_map活动单位配置 =
	{
		...
		{工蜂,	{{"工蜂"	, "活动单位/工蜂",		"语音/zdrYes00"},	 { 2, 0,15},{10, 5,	 2,	0.5f,		"",		0s,				"attack",		600ms,	"音效/ZDrHit00","语音/zdrDth00","died", 300ms},	"语音/zdrRdy00"}},
