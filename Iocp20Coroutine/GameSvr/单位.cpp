...
namespace 单位
{
	...
	std::unordered_map<单位类型, 活动单位配置> g_map活动单位配置 =
	{
		...
		{工程车,{{"工程车"	, "活动单位/工程车",	"语音/是女声可爱版"},{ 3, 0,25},{8 , 5,  1,	0.4f,		"",		0s,				  "attack",		500ms,	 "TSCMin00",	 "TSCDth00","died"}}},
		{兵,	{{"兵"		, "活动单位/步兵",		"语音/是男声正经版"},{ 5, 2,15},{20, 10,  3,	0.5f,		"",		0s,				  "attack",		900ms,	 "音效/TTaFir00","TMaDth00","die01"}}},
		{近战兵,{{"近战兵"	, "axe-yellow",			"tfbPss00"},		 { 8, 3,18},{15, 5,  5,	0.5f,		"",		0s,				  "attack",		600ms,	 "Tfrshoot",	 "TMaDth00","died"}}},
