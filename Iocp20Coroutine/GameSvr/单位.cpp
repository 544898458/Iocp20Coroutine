...
namespace 单位
{
	...
	std::unordered_map<建筑单位类型, 建筑单位配置> g_map建筑单位配置 =
	{
		...
		{地堡, {{"地堡","house_type17"},{30,11,2000}, 2.0f} },
	};
	using namespace std;
	std::unordered_map<活动单位类型, 活动单位配置> g_map活动单位配置 =
	{
		//										晶体燃气HP	  警距 攻距	伤害 移速 前摇动作 dura开始播放攻击动作 攻击动作 dura开始伤害 攻击音效
		{工程车,{{"工程车"	, "altman-yellow"	},{ 3,0,20	}, {8 , 4,  1,	0.4f,	"",		0s,				  "attack",		500ms,	 "TSCMin00"}}},
		{兵,	{{"兵"		, "活动单位/步兵"	},{ 5,2,15	}, {20, 9,  3,	0.5f,	"",		0s,				  "attack",		900ms,	 "音效/TTaFir00"}}},
		{近战兵,{{"近战兵"	, "axe-yellow"		},{ 8,3,18	}, {15, 4,  5,	0.5f,	"",		0s,				  "attack",		600ms,	 "Tfrshoot"}}},
		{三色坦克,{{"三色坦克","活动单位/三色坦克"},{20,10,60},{35,25, 50,	0.1f,	"idle",	5s,			 "attack_loop",		300ms,	 "音效/TTaFi200"}}},
	};
	std::unordered_map<活动单位类型, 怪配置> g_map怪配置 = {
		//									 警距 攻距 伤  移速 前摇动作 dura开始播放攻击动作 攻击动作 dura开始伤害 攻击音效	血量
		{兵,	{{"怪"		, "altman-red"	},{20,8,	5, 0.2f,	"",			0s,			  "attack",	300ms,		"TMaFir00"}, 50} },
		{近战兵,{{"斧头怪"	, "axe-red"		},{15,3,	8, 0.2f,	"",			0s,			  "attack",	300ms,		"Tfrshoot"}, 65} },
	};
