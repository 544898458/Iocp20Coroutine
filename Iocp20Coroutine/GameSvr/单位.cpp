...
namespace 单位
{
	...
	std::unordered_map<单位类型, 活动单位配置> g_map活动单位配置 =
	{
		...
		{工蜂,	{{"工蜂"	, "活动单位/工蜂",		"语音/zdrYes00"},	 { 2, 0,15},{10, 5,	 2,	0.4f,		"",		0s,				"attack",		600ms,	"音效/ZDrHit00","语音/zdrDth00","died", 300ms},	"语音/zdrRdy00"}},
		{兵,	{{"兵"		, "活动单位/步兵",		"语音/是男声正经版"},{ 5, 2,15},{20,10,  3,	0.5f,		"",		0s,				"attack",		900ms,	"音效/TTaFir00","TMaDth00",		"die01",100ms},	"语音/准备战斗男声正经版"}},
		{近战兵,{{"近战兵"	, "活动单位/近战兵",	"tfbPss00"},		 { 8, 3,18},{15, 5,  5,	0.5f,		"",		0s,				"attack",		600ms,	"Tfrshoot",		"TMaDth00",		"died",	100ms},	"tfbRdy00"}},
		...
		{飞机,	{{"飞机","活动单位/飞机",			"语音/ttapss00"},	 {20,10,30},{35,15,	 3,	0.6f,		"",		0s,				"attack",		500ms,	"TMaFir00",		"音效/TTaDth00","died",	200ms},	""}},
	};
