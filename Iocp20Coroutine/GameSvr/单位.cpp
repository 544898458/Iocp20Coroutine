...
namespace 单位
{
	...
	{
		//											选中音效			  晶 燃 HP 警距 攻距 伤害 移速 前摇动作 dura开始播放攻击动作 攻击动作 dura开始伤害	攻击音效		阵亡音效		阵亡动作	入场语音
		{工程车,{{"工程车"	, "活动单位/工程车",	"语音/是女声可爱版"},{ 3, 0,25},{10, 5,  1,	0.4f,		"",		0s,				"attack",		500ms,	"音效/TScFir00","TSCDth00",		"died"},	"语音/工程车准备就绪女声可爱版"}},
		{工蜂,	{{"工蜂"	, "活动单位/工蜂",		"语音/ttapss00"},	 { 2, 0,15},{10, 5,	 1,	0.4f,		"",		5s,				"attack",		500ms,	"音效/ZDrHit00","音效/TTaDth00","died"},	"语音/zdrRdy00"}},
		{兵,	{{"兵"		, "活动单位/步兵",		"语音/是男声正经版"},{ 5, 2,15},{20,10,  3,	0.5f,		"",		0s,				"attack",		900ms,	"音效/TTaFir00","TMaDth00",		"die01"},	"语音/准备战斗男声正经版"}},
		{近战兵,{{"近战兵"	, "axe-yellow",			"tfbPss00"},		 { 8, 3,18},{15, 5,  5,	0.5f,		"",		0s,				"attack",		600ms,	"Tfrshoot",		"TMaDth00",		"died"},	"tfbRdy00"}},
		{三色坦克,{{"三色坦克","活动单位/三色坦克",	"语音/ttapss00"},	 {20,10,60},{35,25,	30,	0.1f,	"idle",		5s,				"attack_loop",	300ms,	"音效/TTaFi200","音效/TTaDth00","die02"},	"语音/ttardy00"}},
	};
	std::unordered_map<单位类型, 怪配置> g_map怪配置 = {
		...
		{近战兵,{{"跳虫", "活动单位/跳虫"},	{15, 4,	  5, 0.35f,	"",			0s,			  "attack",		400ms,	"音效/利爪攻击","音效/ZZeDth00",	"died"}, 60} },
	};
