...
namespace AiCo
{
	...
	CoTaskBool WalkToTarget(Entity& refThis, SpEntity spEntity, FunCancel& funCancel, const bool b检查警戒距离 = true, const std::function<bool(Entity&)>& fun可停下 = [](Entity&){return true; });
